...
#else /* __U_BOOT__ */
# define indent() printf("%*s", (G.debug_indent * 2) & 0xff, "")
#endif /* __U_BOOT__ */
...
#else /* __U_BOOT__ */
#ifndef debug_printf
# define debug_printf(...) (indent(), printf(__VA_ARGS__))
#endif

#ifndef debug_printf_parse
# define debug_printf_parse(...) (indent(), printf(__VA_ARGS__))
#endif

#ifndef debug_printf_heredoc
# define debug_printf_heredoc(...) (indent(), printf(__VA_ARGS__))
#endif

#ifndef debug_printf_exec
#define debug_printf_exec(...) (indent(), printf(__VA_ARGS__))
#endif

#ifndef debug_printf_env
# define debug_printf_env(...) (indent(), printf(__VA_ARGS__))
#endif

#ifndef debug_printf_jobs
# define debug_printf_jobs(...) (indent(), printf(__VA_ARGS__))
# define DEBUG_JOBS 1
#else
# define DEBUG_JOBS 0
#endif
...
#ifndef debug_printf_expand
# define debug_printf_expand(...) (indent(), printf(__VA_ARGS__))
# define DEBUG_EXPAND 1
#else
# define DEBUG_EXPAND 0
#endif
...
#ifndef debug_printf_varexp
# define debug_printf_varexp(...) (indent(), printf(__VA_ARGS__))
#endif

#ifndef debug_printf_glob
# define debug_printf_glob(...) (indent(), printf(__VA_ARGS__))
# define DEBUG_GLOB 1
#else
# define DEBUG_GLOB 0
#endif
...
#ifndef debug_printf_redir
# define debug_printf_redir(...) (indent(), printf(__VA_ARGS__))
#endif

#ifndef debug_printf_list
# define debug_printf_list(...) (indent(), printf(__VA_ARGS__))
#endif

#ifndef debug_printf_subst
# define debug_printf_subst(...) (indent(), printf(__VA_ARGS__))
#endif

#ifndef debug_printf_prompt
# define debug_printf_prompt(...) (indent(), printf(__VA_ARGS__))
#endif

#ifndef debug_printf_clean
# define debug_printf_clean(...) (indent(), printf(__VA_ARGS__))
# define DEBUG_CLEAN 1
#else
# define DEBUG_CLEAN 0
#endif
...
# define bb_verror_msg vprintf
# define bb_error_msg error_msg
# define bb_simple_error_msg puts
...
#define bb_error_msg_and_die(format, ...) do {\
	bb_error_msg(format, __VA_ARGS__); \
	die(); \
} while (0);
...
#else /* __U_BOOT__ */
static void syntax_error_at(unsigned lineno __always_unused, const char *msg)
#endif /* __U_BOOT__ */
{
...
#else /* __U_BOOT__ */
static void syntax_error_unterm_str(unsigned lineno __always_unused, const char *s)
#endif /* __U_BOOT__ */
{
...
#else /* __U_BOOT__ */
static void syntax_error_unexpected_ch(unsigned lineno __always_unused, int ch)
#endif /* __U_BOOT__ */
{
	char msg[2];
	msg[0] = ch;
...
const char defifsvar[] __aligned(1) = "IFS= \t\n";
...
static __always_inline void *mempcpy(void *dest, const void *src, size_t len)
{
...
#else /* __U_BOOT__ */
static __always_inline void o_free(o_string *o)
#endif /* __U_BOOT__ */
{
	free(o->data);
}
...
#else /* __U_BOOT__ */
	printf("%s: list:%p n:%d string_start:%d length:%d maxlen:%d glob:%d quoted:%d escape:%d\n",
#endif
...
#else /* __U_BOOT__ */
			printf("%*s cmd %d assignment_cnt:%d",
#endif /* __U_BOOT__ */
					lvl*2, "", prn,
